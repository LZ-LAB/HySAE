...
from modelHySAEise import HySAE
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", type=float, default=0.00086, nargs="?", help="Learning rate.")
    parser.add_argument("--dr", type=float, default=0.993, nargs="?", help="Decay rate.")
    
    parser.add_argument("--input_drop", type=float, default=0.0, nargs="?", help="input_drop.")
    parser.add_argument("--hidden_drop", type=float, default=0.4, nargs="?", help="hidden_drop.")
    parser.add_argument("--feature_drop", type=float, default=0.9, nargs="?", help="feature_drop.")
    
    parser.add_argument("--pad_mode", type=str, default='zeros', nargs="?", help="convolutional padding mode.")
    
    parser.add_argument("--k_size", type=int, default=1, nargs="?", help="convolutional kernel size.")
    parser.add_argument("--dil_size", type=int, default=2, nargs="?", help="convolutional dilation size.")
    ...
    param['k_size'] = args.k_size
    param['dil_size'] = args.dil_size
    ...
    Exp = Experiment(num_iterations=param['num_iterations'], batch_size=param['batch_size'], lr=param['lr'], dr=param['dr'],
                     ...
                     k_size=param['k_size'], dil_size=param['dil_size'])
    Exp.train_and_eval()
