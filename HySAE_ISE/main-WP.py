...
if __name__ == '__main__':
    ...
    parser.add_argument("--lr", type=float, default=0.00100, nargs="?", help="Learning rate.")
    parser.add_argument("--dr", type=float, default=0.985, nargs="?", help="Decay rate.")
    
    parser.add_argument("--input_drop", type=float, default=0.0, nargs="?", help="input_drop.")
    parser.add_argument("--hidden_drop", type=float, default=0.8, nargs="?", help="hidden_drop.")
    parser.add_argument("--feature_drop", type=float, default=0.2, nargs="?", help="feature_drop.")
