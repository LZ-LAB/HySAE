...
|Ours|**0.881**|**0.823**|**0.931**|**0.982**|

|||WikiPeople|||
|-|-|-|-|-|
|**Model**| **MRR** |**Hit@1**|**Hit@3**|**Hit@10**|
|HyConvE|0.391|0.301|0.429|0.562|
|HJE|0.414|0.324|0.478|0.558|
|Ours|**0.472**|**0.379**|**0.527**|**0.635**|

|||FB-AUTO|||
|-|-|-|-|-|
|**Model**| **MRR** |**Hit@1**|**Hit@3**|**Hit@10**|
|HyConvE|0.953|0.937|0.967|0.976|
|HJE|0.960|0.951|0.967|0.976|
|Ours|**0.968**|**0.962**|**0.972**|**0.978**|
